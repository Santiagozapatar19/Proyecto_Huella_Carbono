"""
Django settings for Huella de Carbono project.
"""
...
ROOT_URLCONF = 'huella_carbono.urls'
...
WSGI_APPLICATION = 'huella_carbono.wsgi.application'

# ─── Base de datos ────────────────────────────────────────────────
# Por defecto SQLite (fácil para desarrollo). Cambia a PostgreSQL en .env
DATABASES = {
    'default': {
